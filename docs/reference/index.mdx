...
In Shake, constants are declared using the `val` keyword, followed by the name of the constant,
a colon and the type of the constant.
...
Consts are used to store data, which cannot be changed during the execution of the program.
