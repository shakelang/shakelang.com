<h1 class="privacy-policy-h1">
  Privacy Policy
  <br />
  <span>Last Updated On 06-Mar-2024</span>
  <br />
  <span>Effective Date 06-Mar-2024</span>
</h1>

<p class="privacy-policy-p">
    This Privacy Policy describes the policies of
    Shake Programming Language, (email: [contact@shakelang.com](mailto:contact@shakelang.com)),
    (We are a non-commercial open-source project and therefore
    do not have a physical address. We are a group of developers)
    on the collection, use and disclosure of your information 
    that we collect when you use our website (https://shakelang.com).
...
<ol class="privacy-policy-ol">
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            ...
            project is merged or acquired with another
            project, your information will be one of the
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            ...
            [contact@shakelang.com](mailto:contact@shakelang.com).
        ...
        <p class="privacy-policy-p">
            ...
            <a href="https://shakelang.com/cookies">Cookie Policy.</a>
        </p>
    </li>
    ...
    <li>
        ...
        <p class="privacy-policy-p">
            ...
            with us, you may email our team at
            [contact@shakelang.com](mailto:contact@shakelang.com),
